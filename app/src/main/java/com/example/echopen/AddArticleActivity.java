...
public class AddArticleActivity extends AppCompatActivity {
    private TitleHandler titleHandler = new TitleHandler(); // Use TitleHandler
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addBlogButton.setOnClickListener(v -> {
            ...
            titleHandler.setTitle(title); // Set the title using TitleHandler
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (userData != null) {
                            ...
                            BlogItemModel blogItem = new BlogItemModel(
                                    titleHandler.getTitle(), // Use TitleHandler to get title
                                    userNameFromDB,
                                    currentDate,
                                    description,
                                    userId,
